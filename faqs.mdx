...
<AccordionGroup>
  <Accordion title="How long should campaigns run?">
    Keep campaigns short and focused. 3 to 7 days for simple actions, 7 to 14 days for moderate actions, 14 to 30 days for complex actions. If no response in 14 days, try a different approach in a new campaign.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="How should I start with Trig?">
    ...
    2. Configure lifecycle stages with 4 to 7 objectives each
  ...
  <Accordion title="How many follow-ups should campaigns have?">
    Most campaigns use 1 to 2 follow-ups. More than that often means your campaign is too broad or the goal is too ambitious. If someone hasn't responded after 2 follow-ups, try a different approach in a new campaign.
  </Accordion>
