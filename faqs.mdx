...
<AccordionGroup>
  ...
  <Accordion title="Do I need to configure stages before using other features?">
    Yes. Lifecycle stages are the foundation that enables everything else in Trig—pattern discovery, Signals, jobs, and measurement all depend on stages being configured first. Start with stages, then build on top.
  </Accordion>
</AccordionGroup>
