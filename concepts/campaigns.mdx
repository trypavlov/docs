...
Most campaigns use 1 to 2 follow-ups. More often indicates the campaign is too broad.
...
<AccordionGroup>
  <Accordion title="How long should campaigns run?">
    Keep campaigns short and focused. 7 to 14 days for most use cases. If no response in 14 days, try a different approach in a new campaign.
  </Accordion>
